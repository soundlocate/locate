...
DissimilarityMeanDist::DissimilarityMeanDist(f64 maxClusterSize) : maxClusterSize(maxClusterSize) {}
...
u64 DissimilarityMeanDist::shouldMerge(const f64 & dissimilarity, const Cluster & a, const Cluster & b) const {
